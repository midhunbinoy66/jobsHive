...
export type AllResTypes = IUserRes | IEmployerRes | IEmployerRes[]|IUserRes[] | IUsersAndCount | IJobssAndCount | IWalletHistoryAndCount|IRevenueData | IChatRes|null| IUsersListForChats[]
